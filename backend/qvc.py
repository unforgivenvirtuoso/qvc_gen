...
async def generate_marketing_copy(title: str, features: list[str]) -> str:
    ...
    Write in a friendly, persuasive tone and highlights unique selling points of the product. Based on the type of product 
    given take that into consideration when generating the marketing copy.
